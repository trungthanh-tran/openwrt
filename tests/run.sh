...
match   "webrtc=2 tproxies STUN over udp"  "$nft" 'udp dport \{ 3478[^}]*\} tproxy ip to :12003'
match   "webrtc=2 tproxies STUN over tcp"  "$nft" 'tcp dport \{ 3478[^}]*\} tproxy ip to :12003'
