...
"$PYTHON_CMD" -m unittest -v tests.test_pool_console tests.test_desktop_core tests.test_desktop_workflows tests.test_desktop_provision tests.test_desktop_gui tests.test_dirty_data tests.test_web_console_i18n tests.test_reset_parity tests.test_web_table_patch tests.test_web_agent_errors tests.test_web_deployer tests.test_console_llm
