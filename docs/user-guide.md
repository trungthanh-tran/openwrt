...
2. Đăng nhập rồi bấm **Kết nối**:
   - **Bản Web:** nhập **tên đăng nhập / mật khẩu** riêng của sbproxy (tạo ở
     lần mở web đầu tiên — router chưa có tài khoản thì trang tự mở form tạo).
     Token chỉ còn nằm trong mục *Nâng cao* —
